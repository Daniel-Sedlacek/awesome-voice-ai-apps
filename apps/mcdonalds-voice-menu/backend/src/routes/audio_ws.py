...
from src.routes.audio import PipelineTimer, run_pipeline
from src.services.stt import create_streaming_session
...
class AudioWSListener(WebsocketListener):
    ...
    async def _handle_start(
        ...
        await stt_session.start(language, on_interim, on_final)
        await socket.send_json({
            "type": "connected",
